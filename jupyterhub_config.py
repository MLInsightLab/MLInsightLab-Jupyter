...
c.JupyterHub.db_url = f'postgresql://{os.environ["JUPYTER_POSTGRES_USER"]}:{os.environ["JUPYTER_POSTGRES_PASSWORD"]}@{os.environ["JUPYTER_POSTGRES_HOST"]}/{os.environ["JUPYTER_POSTGRES_DB"]}'
